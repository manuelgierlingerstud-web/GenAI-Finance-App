...
const I18N = {
  en: {
    ...
    openRouterTooltip: 'Powers the Senior Equity Strategist model analysis across 6 quantitative dimensions via Anthropic Claude Sonnet 5.',
  ...
  de: {
    ...
    openRouterTooltip: 'Treibt die Senior-Equity-Strategist Analyse über 6 quantitative Dimensionen via Claude Sonnet 5 an.',
